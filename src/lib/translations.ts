...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    privacyNotice: 'Your data is processed locally on your device and is never recorded or shared.',
  ...
  tr: {
    ...
    privacyNotice: 'Verileriniz cihazınızda yerel olarak işlenir ve asla kaydedilmez veya paylaşılmaz.',
  ...
  ru: {
    ...
    privacyNotice: 'Ваши данные обрабатываются локально на вашем устройстве и никогда не записываются и не передаются.',
